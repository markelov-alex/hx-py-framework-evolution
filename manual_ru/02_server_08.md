...
Вот мы и реализовали простейшую асинхронность на сопрограммах. Она лучше асинхронности на колбеках, потому что:
 ...
 - возможность использования исключений в сопрограммах так же, как в синхронных программах; тогда как колбеки вызываются из основного цикла (движка), а значит, и исключения из колбеков будут подниматься прямо в движок, где мы их обработать не можем.
