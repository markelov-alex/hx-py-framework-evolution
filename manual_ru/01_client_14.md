...
Вот, наконец, компоненты приобрели, фактически, свой финальный вид, и мы можем перейти дальше — к написанию моделей и контроллеров. С этого момента мы от "разработки фреймворка" переключаемся на "разработку с помощью фремворка".
