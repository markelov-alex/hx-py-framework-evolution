...
import v2.lib.components.Label;
import v2.lib.components.LangPanel;
import v2.lib.components.MusicToggleButton;
import v2.lib.components.MusicVolumeSlider;
import v2.lib.components.SoundToggleButton;
import v2.lib.components.SoundVolumeSlider;
