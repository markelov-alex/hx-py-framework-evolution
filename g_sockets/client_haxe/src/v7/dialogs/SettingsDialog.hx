...
import v7.lib.components.Dialog;
import v7.lib.components.DialogExt;
import v7.lib.components.Label;
import v7.lib.components.LangPanel;
import v7.lib.components.MusicToggleButton;
import v7.lib.components.MusicVolumeSlider;
import v7.lib.components.SoundToggleButton;
import v7.lib.components.SoundVolumeSlider;
