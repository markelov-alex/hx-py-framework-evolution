...
import v1.framework.ui.CheckBox;
...
class Coloring extends Component
{
	...
	override private function assignSkin():Void
	{
		...
		// (Fixing ColoringDialog)
		var controller:IColoringController = ioc.getSingleton(IColoringController);
		controller.load();
	}
	...
	private function refreshPicture():Void
	{
		...
		var pictureSkin = resource.getMovieClip(assetName);
		// Add
