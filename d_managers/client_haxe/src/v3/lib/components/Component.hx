 ...
 * 
 * Changes:
 *  - extract refreshVisible() to make it possible to react 
 *    in subclasses on visible change.
 */
class Component
{
	// Settings
	 ...
	 * After component disposed, it cannot be reused anymore, because 
	 * constructor should be called again, and this is impossible.
	 */
	// Override
