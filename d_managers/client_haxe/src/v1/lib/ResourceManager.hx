...
class ResourceManager
{
	...
	{
//		return if (assetName != null) assetName.split(":")[0] else "default";
		var libraryName = if (assetName.indexOf(":") != -1)
			assetName.split(":")[0] else "default";
		return libraryName;
	}
	
	public static function getSound(assetName:String):Sound
	{
...
//		});
	...
	public static function getMusic(assetName:String):Sound
	{
